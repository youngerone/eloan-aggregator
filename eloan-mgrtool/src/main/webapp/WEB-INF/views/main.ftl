		...
		<div style="width: 1100px;margin: 0 auto;height: 60px;border-bottom: 1px solid #969696;border-right: 1px solid #969696;">
			<table id="total_numbers">
				<tbody><tr valign="bottom" align="center">
					<td style="color:#A8A8A8;">成功借款人数</td>
					<td style="color:#A8A8A8;"></td>
					<td style="color:#A8A8A8;"></td>
					<td style="color:#A8A8A8;"></td>
					<td style="color:#A8A8A8;"></td>
					<td style="color:#A8A8A8;"></td>
				...
				<tr valign="top" align="center" style="margin-top: -5px;">
					<td width="16.66%" style="color: #09d;font-size: 20px;" id="total_bidrequests">
					<#--${summary.successBorrowUserCount}-->
					</td>
	   				<td width="16.66%" style="color: #09d;font-size: 20px;" id="total_bidrequestAmount"></td>
	   				<td width="16.66%" style="color: #09d;font-size: 20px;" id="total_topayAmount"></td>
	   				<td width="16.66%" style="color: #09d;font-size: 20px;" id="total_hastotalAmount"></td>
	   				<td width="16.66%" style="color: #09d;font-size: 20px;" id="total_systemAmount"></td>
	   				<td width="16.66%" style="color: #09d;font-size: 20px;" id="total_corporations"></td>
				</tr>
			</tbody></table>
		</div>
